...
// Adjust to take 'props' as a single object containing 'item' and 'index'
const FaqIteam: React.FC<{ item: any, index: number }> = ({ item, index }) => {
    ...
    <div className="relative z-2 mb-16">
      ...
      >
        <div className="flex-1">
          ...
          <div className={clsx("h6 text-p4 translate-colors duration-500 max-md:flex max-md:min-h-20 max-md:items-center", active && "max-lg:text-p1")}>
            {item.question}
          </div>
        </div>
